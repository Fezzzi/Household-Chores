...
import editorOverlay from 'assets/images/editor-overlay.png'
...
const EditPhotoModal = ({ data: { photoBase, photoObj, onClose } }) => {
  ...
  useEffect(() => {
    ...
    if (canvasContext && (overlayImage.complete && overlayImage.naturalWidth !== 0)) {
      ...
      canvasContext.drawImage(overlayImage, 0, 0)
  ...
  }, [canvasRef.current, overlayImage, offsets, zoom])
