...
import { tDialogsCols, tDialogsName, tUsersCols, tUsersName } from 'serverSrc/database/tables'

exports.up = (pgm: MigrationBuilder) => pgm.sql(`
  CREATE TABLE ${tDialogsName} (
    ${tDialogsCols.user_id} INTEGER PRIMARY KEY REFERENCES ${tUsersName} (${tUsersCols.id}) ON DELETE CASCADE,
